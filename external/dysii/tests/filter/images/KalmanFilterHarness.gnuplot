...
set output "images/KalmanFilterHarness.eps"
...
plot \
"results/KalmanFilterHarness_actual.out" using 2:3 title "actual" with lines linestyle 1,\
"results/KalmanFilterHarness_pred.out" using 2:3 title "filtered" with lines linestyle 2, \
"results/KalmanFilterHarness_pred.out" using (floor($0)%10==0 ? $2 : 1/0):3:7:13 notitle with xyerrorbars linestyle 2, \
