#include "indii/ml/filter/KernelTwoFilterSmoother.hpp"
...
/**
 * @file KernelTwoFilterSmootherHarness.cpp
 *
 * Basic test of KernelTwoFilterSmoother.
 *
 * Results are output into files as follows:
 *
 * @section actualPS results/KernelTwoFilterSmootherHarness_actual.out
 *
 ...
 *
 * @section measPS results/KernelTwoFilterSmootherHarness_meas.out
 * 
 ...
 * @li measurement
 *
 * @section filterPS results/KernelTwoFilterSmootherHarness_filter.out
 *
 ...
 * state variables.
 *
 * @section smoothPS results/KernelTwoFilterSmootherHarness_smooth.out
 *
 ...
 *
 * \image html KernelTwoFilterSmootherHarness.png "Results"
 * \image latex KernelTwoFilterSmootherHarness.eps "Results"
 */
...
int main(int argc, char* argv[]) {
  ...
  ofstream fmeas("results/KernelTwoFilterSmootherHarness_meas.out");
  ofstream factual("results/KernelTwoFilterSmootherHarness_actual.out");
  ofstream ffilter("results/KernelTwoFilterSmootherHarness_filter.out");
  ofstream fsmooth("results/KernelTwoFilterSmootherHarness_smooth.out");
  ...
  KernelTwoFilterSmoother<> smoother(&model, N, K, t, pred, meas);
  ...
  for (t = T - 1; t >= 1; t--) {
    ...
    smoother.smooth(t, ys.top(), incrementFilteredStates.top(), flags);
