...
Traditional methods of analyzing images produced by Function Magnetic Resonance 
...
a computation cost that would allow real time calculations for a multiple voxels
(4 dimensional pixels). More practically, the method described here forms a completely
...
series it should be feasible to calculate parameters and make real-time predictions
