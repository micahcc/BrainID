...
a single false positive would then $0.05$. Unfortunately this leads to unrealistically
...
The most common FMRI analysis technique is called SPM, though there
...
Kalman filter to filter nonlinear signals \cite{Ozakai1994}. 
