...
this question necessitates more complex models and require
...
calculate the Jacobian matrix $\frac{\partial Y}{\theta}$. Thus 
\cite{Friston2002b} approximates the partial using a Volterra Kernel. 
At each step of the Expectation-
Maximization (EM) algorithm, the differential equation is integrated, calculating
...
system with no closed form solution (although \autoref{sec:Linear Approximation}
