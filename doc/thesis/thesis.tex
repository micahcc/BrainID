...
neural activity. At the cost of rather limited temporal resolution, FMRI gives
high spatial for relatively cheap. Whereas other methods
of analyzing neural signals can be invasive or ill-posed, 
FMRI is relatively quick and easy, and its analysis straight forward. Because of
these benefits, FMRI has great potential for studying human cognition.
Unfortunately, FMRI does suffer from severe noise and, as previously
mentioned, low temporal resolution. Because of the extensive noise, 
and relative unpredictability of the absolute signal level, a large amount 
of conditioning is necessary to obtain "valid" activation. In
