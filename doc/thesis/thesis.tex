...
discriminating noise from signal, otherwise analyzing FMRI would be
relatively simple. There is no way to know how much signal is removed
...
remove noise, the analysis method itself must be robust to noise,
