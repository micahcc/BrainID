...
\begin{figure}[H]
\centering
\includegraphics[clip=true,trim=6cm 2cm 6cm 3cm, width=16cm]{images/longfit}}
\caption{BOLD estimate converging for a very long FMRI run.}
\label{fig:long_preprocessed}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[clip=true,trim=6cm 2cm 6cm 3cm, width=16cm]{images/longfit_500}}
