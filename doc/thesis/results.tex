...
\caption[\acs{BOLD} estimate converging for a very long \acs{fMRI} run.]{\acs{BOLD} estimate 
...
\caption[First 500 seconds of the \acs{BOLD} estimate converging for a very 
long \acs{fMRI} run.]{First 500 seconds of \acs{BOLD} estimate 
converging for a 2400 second \acs{fMRI} run. Darker bars indicate
bins with more particles with \acs{BOLD} estimate in that range. ($\sigma_x = 0.0005$, $\sigma_y = 0.001$)}
...
\hline
\end{tabular}
\caption[Estimated Parameters with low noise.]
{Estimated Parameters on 11 different runs with low noise. First row is the true value, 
...
\hline
\end{tabular}
\caption[Estimated Parameters with low noies, and no signal.]
{Estimated Parameters on 11 different runs with low noise and no signal present.
 ($\sigma_x = 0.005$, $\sigma_y = 0.01$)}
...
\subfigure[\ac{SNR} Map of \ac{POSSUM} simulated data. Mean \ac{SNR} per region, 
Region 1: $0.8$, Region 2: $0.97$, and
Region 3: $0.39$.]{\includegraphics[height=9cm]{images/snr_hm.png}\label{fig:SimSNRhm}}

\subfigure[Normalized \ac{RMSR} Map. Scale is Normalized \ac{RMSE}. Lower (yellow) is better.]
{\label{fig:simslice_hm_res} \includegraphics[height=8.5cm]{images/sim_hm}}
\subfigure[\ac{MI} Map. Scale is bits. Higher (yellow) indicates better fit.]
{\label{fig:sim_hm_mi} \includegraphics[height=8.5cm]{images/sim_hm_mi}}
...
\caption[Histogram of estimated parameters in section 1]{Histogram of estimated parameters in 
section 1 in voxels 
...
\caption[Histogram of estimated parameters in section 2]
