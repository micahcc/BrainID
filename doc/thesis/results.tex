...
\begin{figure}[H]
\centering
\includegraphics[width=10cm]{images/simslice_mask}
\caption{Normalized Square Root of the Mean Square Residual. Darker indicates lower error.}
\label{fig:simslice_mask}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=10cm]{images/simslice_hm}
\caption{Normalized Square Root of the Mean Square Residual. Darker indicates lower error.}
...
\begin{figure}[H]
\centering
\includegraphics[width=10cm]{images/simslice_hm85}
...
regions 1 2 an 3 clearly stick out in the $\sqrt{MSR}$ map, indicating that the
