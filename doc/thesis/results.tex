...
{\label{fig:simslice_hm_res} \includegraphics[height=9cm]{images/sim_hm}}
\subfigure[Mutual Information Map. Scale is bits. Higher (yellow) is better.]
{\label{fig:sim_hm_mi} \includegraphics[height=9cm]{images/sim_hm_mi}}
...
of the particle filter at identifying regions of activation.
 The thresholds applied to this
slice, both for mutual information and residuals are arbitrary. Applying a
