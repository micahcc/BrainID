...
program the true signal-to-noise ratio was much lower, as soon in the fit in \autoref{fig:simslicefit1}.

\begin{figure}
%includegraphics[]{images/simslicefit1}
\caption{A single time-series fit in the simulated slice.}
\labe{fig:simslicefit1}
\end{figure}
...
\begin{figure}
\includegraphics[]{images/simslice_hm}
\caption{Normalized Square Root of the Mean Square Residual. Darker indicates lower error.}
\label{fig:simslice_hm}
\end{figure}

\begin{figure}
\includegraphics[]{images/simslice_hm85}
\caption{Normalized Square Root of the Mean Square Residual, with upper threshold at .85. 
Darker indicates lower error.}
\label{fig:simslice_hm85}
\end{figure}

\begin{figure}
\includegraphics[]{images/parameters_sec1}
\caption{Histogram of estimated parameters in section with true parameters of $\{ \}$
Limited to areas with residual less than $.85$.}
\label{fig:parameters_sec1}
\end{figure}

\begin{figure}
\includegraphics[]{images/parameters_sec2}
\caption{Histogram of estimated parameters in section with true parameters of $\{ \}$
Limited to areas with residual less than $.85$.}
\label{fig:parameters_sec2}
\end{figure}

\begin{figure}
\includegraphics[]{images/parameters_sec3}
\caption{Histogram of estimated parameters in section with true parameters of $\{ \}$. 
Limited to areas with residual less than $.85$.}
\label{fig:parameters_sec3}
\end{figure}
