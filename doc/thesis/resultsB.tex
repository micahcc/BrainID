...
\begin{figure}[H]
\subfigure[]{\label{fig:hm_spm} \includegraphics[scale=3]{images/spm_hm}}
...
\begin{figure}[H]
\subfigure[]{\label{fig:hm_pfilter} \includegraphics[scale=3]{images/pfilter_hm}}
...
\begin{figure}[H]
\subfigure[]{\label{fig:hm_pfilter85} \includegraphics[scale=3]{images/pfilter85_hm}}
