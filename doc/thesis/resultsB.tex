...
\caption[Particle Filter \acs{MI} Results]
...
\caption[Time Series Comparison, Section 1]{Section 1, Estimated vs. Actual \ac{BOLD} response. $t$-Score: $10.71$, \ac{MI}: $0.33$, Residual: $0.72$.}
\label{fig:comp1}
\end{figure}
...
\caption[Time Series Comparison, Section 2]{Section 2, Estimated vs. Actual \ac{BOLD} response. $t$-Score: $6.97$, \ac{MI}: $0.04$, Residual: $1.02$.}
\label{fig:comp2}
\end{figure}
...
\caption[Time Series Comparison, Section 3]{Section 3, Estimated vs. Actual \ac{BOLD} response. $t$-Score: $2.85$, \ac{MI}: $-0.03$, Residual: $0.81$.}
\label{fig:comp3}
\end{figure}
...
\caption[Time Series Comparison, Section 4]{Section 4, Estimated vs. Actual \ac{BOLD} response. $t$-Score: $0.50$, \ac{MI}: $0.06$, Residual: $0.95$. }
\label{fig:comp4}
\end{figure}
...
\caption[Time Series Comparison, Section 5]{Section 5, Estimated vs. Actual \ac{BOLD} Response. $t$-Score: $4.17$, \ac{MI}: $0.02$, Residual: $1.14$.}
...
\caption[Time Series Comparison, Section 6]{Section 6, Estimated vs. Actual \ac{BOLD} Response. $t$-Score: $2.49$, \ac{MI}: $.34$, Residual: $0.78$.}
