...
\begin{frame}{BOLD State Space Model}
  ...
  \begin{column}{.7\textwidth}
    ...
    \end{eqnarray}
    \item Output:
    $$y(t) = {\color{mred}V_0}(a_1( 1 - {\color{mblue}Q(t)}) - a_2(1 - {\color{mblue}V(t)}))$$
    \end{itemize}
  \end{column}
...
\begin{itemize}
    ...
    \small
    \begin{figure}
    \includegraphics[width=.7\textwidth]{simulated_annealing}
    \caption{Simulated Annealing can escape local minima with chaotic jumps. \cite{Dama}}
    \end{figure}
    \begin{figure}
    \includegraphics[width=.7\textwidth]{kalman}
    \caption{(a) Initial Belief  (b) Noisy Measurement  (c) incorporated into the belief. \cite{Thrun2005}}
    \end{figure}
    \end{column}
    \end{columns}
\end{itemize}
...
\item Given:
    ...
    \end{itemize}
\item Particle Consists of:
    \begin{itemize}
    \item Location (Altered By Speed/Direction) $[0, 20]$
    \item Direction (Constant, Unknown) $\{Left, Right\}$
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item Incorporating Measurement:\\
