...
\cite{Johnston2007}. This however was quite slow, and the results
were inconsistent with other similar works. 
Murray used a particle filter, similar to \cite{Johnston2007}, but
...
realistic waveform for the CBF and CMRO2 \cite{Buxton1998}. Friston et al. \cite{Friston2000}
...
blood flow. By combining these equations with 
...
Arulampalam et al. \cite{Arulampalam2002a} and Thrun et al. \cite{thrun2008probabilistic}.
...
weight is given \cite{Liu1998}. An approximation of 
...
\cite{Friston2002b}. Future works that attempt to calculate parameters
