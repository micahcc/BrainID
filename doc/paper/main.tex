...
%TODO double check the error measurement, add min/max/mean errors for the runs
\begin{table}[!t]
...
noiseless BOLD signal) for the 2400s run was %TODO
...
{\label{fig:sim_hm_mi} \includegraphics[width=4cm]{images/sim_hm_15_6.png}}
\subfigure{\includegraphics[width=.6cm]{images/scale6.png}}
