...
#ifndef __modNiftiImageIO_h
#define __modNiftiImageIO_h
 ...
 * \ingroup IOFilters
 */
class ITK_EXPORT modNiftiImageIO : public ImageIOBase
{
public:
  /** Standard class typedefs. */
  typedef modNiftiImageIO       Self;
  ...
  itkTypeMacro(modNiftiImageIO, Superclass);
...
private:
  ...
  modNiftiImageIO(const Self&); //purposely not implemented
  void operator=(const Self&); //purposely not implemented
};

} // end namespace itk

#endif // __modNiftiImageIO_h
