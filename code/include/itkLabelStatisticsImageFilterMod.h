/*=========================================================================
  ...
  Module:    $RCSfile: itkLabelStatisticsImageFilterMod.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkLabelStatisticsImageFilterMod_h
#define __itkLabelStatisticsImageFilterMod_h
...
/** \class LabelStatisticsImageFilterMod 
 ...
 *
 * LabelStatisticsImageFilterMod computes the minimum, maximum, sum,
...
class ITK_EXPORT LabelStatisticsImageFilterMod : 
    public ImageToImageFilter<TInputImage, TInputImage>
{
public:
  /** Standard Self typedef */
  typedef LabelStatisticsImageFilterMod                  Self;
  ...
  itkTypeMacro(LabelStatisticsImageFilterMod, ImageToImageFilter);
  ...
  typedef std::list<LabelPixelType> ListType;
  ...
  ListType GetLabels() const
  {
        ListType ret;
        MapConstIterator it = this->m_LabelStatistics.begin() ;
        while(it != this->m_LabelStatistics.end()) { 
...
private:
  LabelStatisticsImageFilterMod(const Self&); //purposely not implemented
...
#include "itkLabelStatisticsImageFilterMod.txx"
#endif
