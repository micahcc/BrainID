...
Module:    $RCSfile: itkLabelStatisticsImageFilterMod.txx,v $
Language:  C++
...
=========================================================================*/
#ifndef __itkLabelStatisticsImageFilterMod_txx
#define __itkLabelStatisticsImageFilterMod_txx
...
LabelStatisticsImageFilterMod<TInputImage, TLabelImage>
::LabelStatisticsImageFilterMod()
{
...
{
  IndexType tmpindex;
  typename TInputImage::PointType tmppoint;
  RealType value;
  ...
  while (!it.IsAtEnd())
    ...
    this->GetInput()->TransformIndexToPhysicalPoint(it.GetIndex(),
                tmppoint);
    this->GetLabelInput()->TransformPhysicalPointToIndex(tmppoint, 
                tmpindex);
    labelIt.SetIndex(tmpindex);
    label = labelIt.Get();
...
template<class TInputImage, class TLabelImage>
typename LabelStatisticsImageFilterMod<TInputImage, TLabelImage>::RealType
LabelStatisticsImageFilterMod<TInputImage, TLabelImage>
...
template<class TInputImage, class TLabelImage>
typename LabelStatisticsImageFilterMod<TInputImage, TLabelImage>::BoundingBoxType
LabelStatisticsImageFilterMod<TInputImage, TLabelImage>
...
template<class TInputImage, class TLabelImage>
typename LabelStatisticsImageFilterMod<TInputImage, TLabelImage>::RegionType
LabelStatisticsImageFilterMod<TInputImage, TLabelImage>
...
template<class TInputImage, class TLabelImage>
typename LabelStatisticsImageFilterMod<TInputImage, TLabelImage>::HistogramPointer
LabelStatisticsImageFilterMod<TInputImage, TLabelImage>
...
void 
LabelStatisticsImageFilterMod<TImage, TLabelImage>
